...
const Footer = () => {
  ...
  return (
    <footer className="max-w-6xl mx-auto border-t-1 border-gray-900 dark:border-white py-6 px-4 mt-10">
      <div className="container mx-auto flex flex-col gap-y-5 justify-between items-center">
        ...
        <a
          ...
          className="text-[15px] sm:text-[20px] hover:text-blue-600 cursor-pointer font-light"
        >
